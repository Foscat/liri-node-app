...
var queryUrl = "http://www.omdbapi.com/?t=" + term + "&y=&plot=short&apikey=" + keys.omdb.apikey;
...
var queryURL = "https://rest.bandsintown.com/artists/" + term + "/events?app_id=" + keys.bandsintown.APP_ID;
var request = require("request");
var moment = require('moment');
var date = moment().format("llll");
// console.log(date);
